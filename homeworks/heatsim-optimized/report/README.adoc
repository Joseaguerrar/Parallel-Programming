...
|2 |1 |Un solo hilo |1
|3 |hC |Tantos hilos como la mitad de CPUs hay en la computadora que ejecuta el programa |6
|4 |1C |Tantos hilos como CPUs hay en la computadora que ejecuta el programa |12
|5 |2C | |Dos hilos por cada CPU que hay en la computadora que ejecuta el programa |24
|6 |4C | |Cuatro hilos por cada CPU que hay en la computadora que ejecuta el programa |48
|7 |D | |Tantos hilos como unidades de descomposición hay en la entrada|30114
|===