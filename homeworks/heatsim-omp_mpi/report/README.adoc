...
La implementación con MPI a pesar de ser nula es compilable, sin embargo, por errores desconocidos y repito, por cuestiones de tiempo, no se pudieron depurar para encontrar el error.
